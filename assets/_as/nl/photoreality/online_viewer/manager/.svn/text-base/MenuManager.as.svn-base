package nl.photoreality.online_viewer.manager {
	import flash.display.Bitmap;
	import flash.events.Event;
	import flash.events.EventDispatcher;
	import nl.photoreality.map_editor.model.RouteModel;
	import nl.photoreality.map_editor.model.vo.RouteVO;
	import nl.photoreality.online_viewer.view.map.MapMain;
	import nl.photoreality.online_viewer.view.menu.button.DepartmentLabelButton;
	/**
	 * ...
