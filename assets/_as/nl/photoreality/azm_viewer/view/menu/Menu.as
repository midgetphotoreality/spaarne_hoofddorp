package nl.photoreality.azm_viewer.view.menu 
{
	...
	import nl.photoreality.azm_viewer.view.menu.button.IndexLabelButton;
	...
	public class Menu extends MovieClip
	{
		...
		private var _onlyIncludePostFixPattern:String;
		
		public function Menu(routes:Vector.<RouteVO>,onlyIncludePostFixPattern:String="") {
			_onlyIncludePostFixPattern = onlyIncludePostFixPattern;
			_routes 	= routes
		...
		/*public function reInit(onlyIncludePostFixPattern:String):void {
			init(onlyIncludePostFixPattern);
		}*/
		...
		private function init():void {
			...
			for (i = 0; i < _alphabeth.length; i++) {
				...
				_indexButton.x = 0;
				_indexButton.y = (21 * i)
				_indexButton.init(name, buttonDepartments,_onlyIncludePostFixPattern);
			}
			/*
