...
SHoofddorp.Menu = (function () {
	...
	var _initMenu = function (routes) {
		...
		//_buildMenu();
		/*
		Core.debug.groupCollapsed("SHoofddorp menu:");
		...
		Core.debug.groupEnd();
		*/
		//SHoofddorp.Menu.selectTransportMode('transport_car');
	}
	...
	var _selectTransportMode = function (transVar) {
		...
		if (transVar == _transVarTrain || transVar == _transVarCar || transVar == _transVarBus) {
			...
			Core.debug.log("SHoofddorp.Menu.selectTransportMode(" + transVar + ")")
	...
	var _buildMenu = function (selectedRoute) {
		...
		htmlVergaderzalen = '<select name="departments" id="select_vergaderzalen" class="menuRouteList" onchange="SHoofddorp.Menu.selectRoute(this)" value=""><option value="">Vergaderzalen</option>';

		htmlVerdiepingen = '<select name="departmentsTop" id="select_verdiepingen" class="menuRouteList" onchange="SHoofddorp.Menu.selectRoute(this)" value=""><option value="">Verdiepingen</option>';
