...
HOSPITALS.Controller = (function() {
	...
	var _loadFloors = function(callback){
		//console.log("lf: "+_currentLoadedFloor)
	...
	var _loadFloor = function(floor,callback){
		...
		floor.floorImg.onload = function(){
			...
			if(_setFloorWidth!=false){
					floorWidth = _setFloorWidth;
			}
			
			if(_setFloorMargin!=false){
					floorWidth = floorWidth - (_setFloorMargin*2);
			}
...
*/	
	...
	*/
	...
	var _public = {
		setFloorWidth: function(w){_setFloorWidth = w},
		setFloorMargin: function(w){_setFloorMargin = w},
...
HOSPITALS.MapsContainer = (function() {
	...
	*/
	...
	var _init = function(){
		...
		_setFloor1("fl5a09086faa86ba6d507c8721aca6f1b265b3e41262d2a6bb4c668e2067e8b51c");
	}
	...
	var _drawRoute = function(route){
      ...
      // context.clearRect ( 0 , 0 , 600 , 600 );
		...
		context.strokeStyle = "#6FB640";//"#88c3178";// col;//"#ff0000";//+parseInt(HOSPITALS.Model.getData().lineColor).toString(16);
	...
	*/
	...
	var _public = {
		...
		selectedFloor2: function(){return _selectedFloor2;},
		selectedFloor1: function(){return _selectedFloor1;}
	}
	return (_public);
})(); 
